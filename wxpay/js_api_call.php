		...
		function jsApiCall()
		{
			WeixinJSBridge.invoke(
				...
				function(res){
				      ...
				      {
					      window.location.href="http://www.chenvxu.com/mobile/index/WxPay?act=wxpay_success&order_sn=<?php echo $out_trade_no;?>";
					  }
					  if(res.err_msg=='get_brand_wcpay_request:cancel')
				      {
						 ...
						 window.location.href="http://www.chenvxu.com/mobile/index/WxPay?act=wxpay_fail";
					  }
