		...
		function jsApiCall()
		{
			WeixinJSBridge.invoke(
				...
				function(res){
				      ...
				      {
					      window.location.href="http://wellcn.duapp.com/index.php/user/WxPay?act=wxpay_success&order_sn=<?php echo $out_trade_no;?>";
					  }
					  if(res.err_msg=='get_brand_wcpay_request:cancel')
				      {
					     //window.location.href="http://www.chenvxu.com/mobile/my.php?act=wxpay_fail&order_sn=<?php echo $out_trade_no;?>&goods_name=<?php echo $goods_name;?>&order_amount=<?php echo $order_amount;?>";
						 window.location.href="http://wellcn.duapp.com/index.php/user/WxPay?act=wxpay_fail";
					  }
